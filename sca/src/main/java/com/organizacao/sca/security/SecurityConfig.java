package com.organizacao.sca.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
			...
			.antMatchers("/alunos/**").hasAnyRole("PREFESSORES", "AUXILIARES", "ADMINISTRADORES")
                        .antMatchers("/matriculas/**").hasAnyRole("PREFESSORES", "AUXILIARES", "ADMINISTRADORES")
